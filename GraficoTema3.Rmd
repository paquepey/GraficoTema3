...
# Hacer que el trazo de España se dibuje con un trazo grueso
...
saveWidget(p_plotly, file = "GraficoTema3.html", selfcontained = TRUE)

# Guardar el 'plotly' en '.pdf'
ggsave("GraficoTema3.pdf", p, device = "pdf")
```
